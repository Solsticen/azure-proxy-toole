cat > azure_proxy_bootstrap_jpe.sh <<'BOOTSTRAP'
#!/usr/bin/env bash
set -euo pipefail

# =========================================================
# Azure Cloud Shell Bootstrap - SOCKS5 Proxy Tool (Japan East)
# Repo gốc: https://github.com/Solsticen/azure-proxy-tool
#
# Default:
...
echo "=================================================="
echo " Azure SOCKS5 Proxy Tool - Cloud Shell (Japan East)"
echo "=================================================="
echo
...
chmod +x azure_proxy_bootstrap_jpe.sh
bash azure_proxy_bootstrap_jpe.sh
